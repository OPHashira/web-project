<?php
   ...
   $data=array_unique(getMovieInfo($_GET['filmName']));
...
<body>
    <form action="selectedTypeFilm-login-template.php" method="post">
                    ...
                    <ul class="homepage-ul cen">
                        <li class="nav-search-box">
                            <div class="search-box">
                                ...
                                <input placeholder="Search by genre" type="search" class="search-platform">
                            </div>
                        </li>
                    </ul>
        ...
        <!-- ==========================================================-->
    <main class="filmPage main">
        <videoContainer>
            <iframe width="100%" height="620" src="https://www.youtube.com/embed/7GvVdTErW9U" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            <videoInfo class="videoInfo">
                <form action="./bookmark.php" method="post">
                    <input type="hidden" value="<?=$data['MovieID']?>" name="movieid">
                    <input type="hidden" value="<?=$_SESSION['username']?>" name="user">
                    <button style="border-radius:6px;" type="submit">Bookmark</button>
                </form>
                <h3>About</h3>
                <p><?=$data['Plot']?></p>
                <p>Current rating: 
                <?=$data['Star']?> <span class="fa fa-star star-checked">(IMDb)</span>
                </p>
                <p>Genre:
                    <?=$data['Genres']?>
                </p>
                ...
                <p>Length: <?=$data['MovieLength']?> minutes</p>
            </videoInfo>
        </videoContainer>
        <relatedContent>
        ...
        <article class="main">
                ...
                <container>
                    <figure>
                        <img src="./img-gif/Poster1.jpg" alt="something">
                        <p>
                    ...
                    <figure>
                        <img src="./img-gif/Poster2.jpg" alt="something">
                        <p>
                            <star>5 <span class="fa fa-star star-checked"></span></star>
                            something
                        </p>
                    ...
                    <figure>
                        <img src="./img-gif/Poster3.jpg" alt="something">
                        <p>
                            <star>5 <span class="fa fa-star star-checked"></span></star>
                            something
                        </p>
                    ...
                    <figure>
                        <img src="./img-gif/Poster4.jpg" alt="something">
                        <p>
                            <star>5 <span class="fa fa-star star-checked"></span></star>
                            something
                        </p>
                    ...
                    <figure>
                        <img src="./img-gif/Poster5.jpg" alt="something">
                        <p>
                            <star>5 <span class="fa fa-star star-checked"></span></star>
                            something
                        </p>

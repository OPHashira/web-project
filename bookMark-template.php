    ...
    <header>
        <nav class="homepage-nav">
            ...
            <ul class="homepage-ul rig">
                <li class="rtl">
                    <a href="./userinfo-template.html" class="default-icon"><div class="user"></div></a>
                </li>
        ...
        <article class="finding">
            <container>
                ...
                if ($data!=null){
                    foreach($data as $i){
                ?>
                    <figure onclick="moveTo('./filmPage-login-template.php?filmName=<?=$i['Title']?>')">
                        <div class="row">
                            <img src="<?=$i['image']?>" alt="something">
                            <h3><?=$i['Title']?></h3>
                        </div>
                        <div class="row-right">
                            <h4 style="margin-bottom: -26px;">Description</h4>
                            <text style=""><?=$i['Plot']?></text>
                            <star>
                                <?=$i['Star']?><span class="fa fa-star star-checked"></span>
                            </star>
                            <p>Number of rating: <?=number_format($i['NumOfRating'])?></p>
                        </div>
                    </figure>
                    <?php
                    }

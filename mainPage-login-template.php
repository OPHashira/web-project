...
<body class="mainpage-body">
                ...
                <ul class="homepage-ul cen">
                    <li class="nav-search-box">
                        ...
                        <div class="search-box">
                            ...
                            <input id="filmName" placeholder="Search by genre" type="text" class="search-platform" name="genre">
                        </div>
                    ...
                    <?php 
                        if ($isLog==="admin")
                        {
                            ...
                            <li class="nav-button rtl">
                                <button type="button" class="custom-btn-MP-default ct-color" onclick="moveTo('./addFilm.php')">
                                add Film
                                </button>
                            </li>
                            <?php
    ...
    <aside>
            <nav class="side-nav">
                <ul>
                    <li ><a href="./selectedTypeFilm-login-template.php?genre=comedy" value="action">Action</a></li>
                    <li><a href="./selectedTypeFilm-login-template.php?genre=comedy" value="comedy">Comedy</a></li>
                    <li><a href="./selectedTypeFilm-login-template.php?genre=horror" value="horror">Horror</a></li>
                    <li><a href="./selectedTypeFilm-login-template.php?genre=drama" value="drama">Drama</a></li>
                    <li><a href="./selectedTypeFilm-login-template.php?genre=fantasy" value="fantasy">Fantasy</a></li>
                    <li><a href="./selectedTypeFilm-login-template.php?genre=mystery" value="mystery">Mystery</a></li>
                    <li><a href="./selectedTypeFilm-login-template.php?genre=science fiction" value="scifi">Sci-Fi</a></li>
                    <li><a href="" value="romance">Romance</a></li>
                </ul>
            </nav>
        </aside>
    ...
    <main class="main">
        ...
        <article class="main">
            ...
            <container>
                ...
                ?>
                    <figure>
                        ...
                        <a href="./filmPage-login-template.php?filmName=<?=$i['Title']?>">
            ...
            <container>
                <figure onclick="moveTo('./filmPage-login-template.php')">
            ...
            if(input !=""){
                $.ajax({
                    ...
                    success:function(result){
                        ...
                        $("Search_result").css("display","absolute");
                    }
                });
            }else{

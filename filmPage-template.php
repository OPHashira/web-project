...
<body>
            ...
            <header>
                <nav class="homepage-nav">
                    <ul class="homepage-ul lef">
                        <li class="logo-li"><a href="./index.php" class="logo"><img src="./img-gif/logovector.avif" alt="logo" class="logo-img"></a></li>
                    </ul>
                    <ul class="homepage-ul cen">
                        <li class="nav-search-box">
                            <div class="search-box">
                                ...
                                <input placeholder="Search" type="search" class="search-platform">
                            </div>
                        </li>
                    </ul>
    ...
    <videoContainer>
            ...
            <videoInfo class="videoInfo">
                ...
                <p><?=$data['Plot']?></p>
                <p>Current rating: 
                <?=$data['Star']?><span class="fa fa-star star-checked"></span>
                </p>
                <p>Genre:
                    <?=$data['Genres']?>
                </p>
